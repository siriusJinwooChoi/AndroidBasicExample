	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        progressButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                mProgress = 0;
                mProgressDialog.setProgress(0);             //dialog 상태(진행바가 0에 있음)
                mProgressHandler.sendEmptyMessage(0);       //handler러가 아래 준비되있고, 이걸 사용함.
            }
        });
        ...
        mProgressHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (mProgress >= MAX_PROGRESS) {
                    mProgressDialog.dismiss();                                  //창을 닫을 때
                } else {
                    mProgress++;                                                 //변수 0에서 ,
                    mProgressDialog.incrementProgressBy(1);                     //1씩 증가시켜줌.
                    mProgressHandler.sendEmptyMessageDelayed(0, 100);           //재귀호출을 통하여 0~100까지 증가시켜주는 역할을 함.
                }
            }
        };
    }
